...
cluster_models = {
    "KMeans": KMeans(
        n_clusters=8, init="k-means++", n_init=10, max_iter=300, random_state=0
    ),
    "AgglomerativeClustering_Ward": AgglomerativeClustering(
        n_clusters=8, affinity="euclidean", linkage="ward"
    ),
    "AgglomerativeClustering_Average": AgglomerativeClustering(
        n_clusters=8, affinity="euclidean", linkage="average"
    ),
}
